...
export default function OrganizationSupportTicketDetailPage() {
  ...
  useEffect(() => {
    ...
    if (session && ticketId && organizationSlug) {
      fetchTicket()
    }
  }, [session, isPending, ticketId, organizationSlug])
  ...
  return (
    <SupportMessagesProvider ticketId={ticketId} organizationId={organizationSlug}>
      <div className="container mx-auto px-4 py-8">
        <div className="max-w-4xl mx-auto">
        {/* Header */}
        <div className="mb-6">
          <Button 
            variant="ghost" 
            onClick={() => router.push(`/${organizationSlug}/support`)}
            className="mb-4"
          >
            <ArrowLeft className="h-4 w-4 mr-2" />
            Back to Organization Support
          </Button>
