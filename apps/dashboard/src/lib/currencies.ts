export const currencies = {
    ...
    MRO: { name: "Mauritanian Ouguiya (pre-2018)", symbol: "UM" },
    ...
    SLL: { name: "Sierra Leonean Leone (pre-2022)", symbol: "Le" },
    SOS: { name: "Somali Shilling", symbol: "S" },
    SRD: { name: "Surinamese Dollar", symbol: "$" },
    SSP: { name: "South Sudanese Pound", symbol: "£" },
    STD: { name: "São Tomé and Príncipe Dobra (pre-2018)", symbol: "Db" },
